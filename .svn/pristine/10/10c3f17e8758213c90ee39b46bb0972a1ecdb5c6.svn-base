...
public class TC_06_FranceFrenchCustomerActivation extends ConfigLib {
	...
	public static String accountCreation() {
		...
		MVNOProjectSpecific.joiLibertyFrenchPricePlan();
		...
		*/ 
		...
		MVNOProjectSpecific.Customer_details("Mr.", username, "MVNO", "France Automation", "01011960", "0123467890");
		FranceProjectSpecific.uploadCustomerIdCopyForFrench_French();
		MVNOProjectSpecific.contactAndBillingAdress("75005", "7", "5");
		...
		MVNOProjectSpecific.orderSummaryPageForNewFrenchCustomer("999999");
		...
		MVNOProjectSpecific
				.takeScreenShot(".//ScreenShots/France_French/France_French_Order_Creation.png");
