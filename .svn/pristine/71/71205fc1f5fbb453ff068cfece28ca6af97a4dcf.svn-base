...
public class TC_02_UK_JOi_Medium_Talkplan_New_Customer extends ConfigLib {
	...
	public String accountCreationForUKCustomer() {
		...
		// step 3:check the radio button 'Joi Medium' ----PRICE PLAN SELECTION
		UKProjectSpecific.Joi_Medium_price_plan();
		...
		UKProjectSpecific.contactAndBillingAdress("SW9 5XG", "01");
