...
public class TC_04_FranceAddLibertyPricePlanOrderToExistingCustomer {
	...
	public static String orderCreationForExistingCustomer() {
		...
		MVNOProjectSpecific.takeScreenShot("C:/testing/workspace/Screenshots/mvno/France_Order_Creation.png");
