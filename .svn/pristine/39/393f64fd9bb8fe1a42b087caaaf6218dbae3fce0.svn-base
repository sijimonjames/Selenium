...
public class TC_04_FR_JOi_Egalite_French_New_Customer extends ConfigLib {
	...
	public String account_creation() {
		...
		MVNOProjectSpecific.takeScreenShot(".//Screenshots/France_French/TC01/Order_Creation.png");
