...
public class TC_01_UK_JOi_Small_Talkplan_New_Customer extends ConfigLib {
	...
	public void CustomerActivation() {
		...
		Reporter.log("TC_01_UK_JOi_Small_Talkplan_New_Customer", true);
	...
	public String accountCreationForUKCustomer() {
		...
		UKProjectSpecific.Joi_Small_price_plan();
		...
		UKProjectSpecific.customerDetails("MVNO", "Automation", "29021992", "03800000025");
		...
		driver.quit();
		Reporter.log("Order is created, UK Order number is: " + orderNumber, true);
