package com.acneuro.test.automation._02_FR_English_price_plans;
...
public class TC_09_FR_JOi_Fraternity_English_New_Customer_Auto_Billing extends ConfigLib {
	...
	public void franceCustomerAutoBillingProcess() throws InterruptedException {
		...
		Reporter.log(String.format("Auto Billing is Completed for Order %s", orderNumber), true);
