...
public class TC_06_UK_JOi_Small_Talkplan_ExistingCustomer {
	...
	public static String orderCreationForExistingCustomer() {
		...
		UKProjectSpecific.LoginToUKMyJoiWithLatestEmailID(emailId);
		UKProjectSpecific.joiSmallOrderSelectionFromOurOffer();
		...
		System.out.println("Order number is created: " + orderNumber);
