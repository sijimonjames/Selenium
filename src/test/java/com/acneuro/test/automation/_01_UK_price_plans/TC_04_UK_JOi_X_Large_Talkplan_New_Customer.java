...
public class TC_04_UK_JOi_X_Large_Talkplan_New_Customer extends ConfigLib {
	...
	public String accountCreationForUKCustomer() {
		...
		/*
		 * step 3:check the radio button 'Joi X Large Price Plan' ----PRICE PLAN
		 * SELECTION
		 */
		UKProjectSpecific.Joi_X_Large_price_plan();
		...
		UKProjectSpecific.customerDetails("MVNO", "Automation", "31121966", "03900000001");
