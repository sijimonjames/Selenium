...
public class TC_05_DK_JOi_Egalitte_Danish_ExistingCustomer {
	...
	public static String orderCreationForExistingCustomer() {
		...
		FranceProjectSpecific.joiEgaliteOrderSelectionFromOurOffer_FR();
		MVNOProjectSpecific.pricePlanSelection_France_French("joiEgalitteFR");
