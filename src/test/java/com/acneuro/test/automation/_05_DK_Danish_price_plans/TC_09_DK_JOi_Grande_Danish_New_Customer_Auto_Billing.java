package com.acneuro.test.automation._05_DK_Danish_price_plans;
 ...
 * Test: France - French Auto-billing and Activation
 */

public class TC_09_DK_JOi_Grande_Danish_New_Customer_Auto_Billing extends ConfigLib {
	...
	public String account_creation() {
		...
		MVNOProjectSpecific.pricePlanSelection_France_French("joiFraternityFR");
		...
		FranceProjectSpecific.customerDetails("MVNO", "Fr AutoBilling", "01011970", "0234678901");
		...
		MVNOProjectSpecific.takeScreenShot(".//Screenshots/France_French/TC12/Auto_Billing_Tests.png");
