 ...
 * Test: France - French customer account creation, order a price plan Liberty
 * and subscription activation
 */

public class TC_01_DK_JOi_Fraternity_Danish_New_Customer extends ConfigLib {
	...
	public String account_creation() {
		...
		Reporter.log(String.format("Email address is updated to %s", Constant.PERSONAL_EMAIL_ADRRESS), true);
