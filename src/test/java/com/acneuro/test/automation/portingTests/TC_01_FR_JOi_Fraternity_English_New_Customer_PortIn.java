...
public class TC_01_FR_JOi_Fraternity_English_New_Customer_PortIn extends ConfigLib {
	...
	public String accountCreation() throws InterruptedException {
		...
		// step 3:check the radio button 'Joi Fraternity' ----PRICE PLAN SELECTION
		MVNOProjectSpecific.pricePlanSelection_France_English("joiFraternityFR");
		...
		MVNOProjectSpecific.takeScreenShot(String.format("%s"+"portin_order_creation_page_New.png", directory));
		...
		FranceProjectSpecific.customerDetails("MVNO", "France Automation", "01011995", "0467890123");
		FranceProjectSpecific.uploadCustomerIdCopyForFrenchEnglish();
		FranceProjectSpecific.contactAndBillingAdress("75007", "38");
	...
	@Test
	public void customerActivationWithPortIN() throws SQLException, InterruptedException {
