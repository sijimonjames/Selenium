...
import static com.acneuro.test.automation.db_connection_libraries.OracleDBUtils.queryActionInstanceWithProcessIdAndActionName;
...
public class TC_02_UKPortOutTests {
...
//		UKProjectSpecific.ukUrlSelection();
		...
		// AFTER SUBMIT, 'pONumPos' ACTION WILL BE INITIATED,
