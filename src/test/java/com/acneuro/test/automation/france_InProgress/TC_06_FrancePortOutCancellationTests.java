...
public class TC_06_FrancePortOutCancellationTests {
	@Test
	public void portoutFrance() {
		...
		//PORTOUT cancellation request
		String apiCancellation = RestApiAutomation.secondRequestToCancelPortoutForFrance(msisdn, portOutId);
		System.out.println(apiCancellation);
