...
public class TC_07_FR_JOi_Big_French_ExistingCustomer {
	...
	public static String orderCreationForExistingCustomer() {
		...
		FranceProjectSpecific.joiGrandeOrderSelectionFromOurOffer_FR();
		MVNOProjectSpecific.pricePlanSelection_France_French("joiBigFR");
